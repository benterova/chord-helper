...
export const ScaleDetails: React.FC = () => {
    ...
    return (
        <div style={{
            ...
            <div style={{ marginTop: '15px', fontSize: '0.9rem', color: '#004466', padding: '10px', background: 'rgba(255,255,255,0.4)', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.5)' }}>
                <strong>Tip:</strong> Click on chords in the Circle of Fifths to play them.
            </div>
        </div>
    );
};
